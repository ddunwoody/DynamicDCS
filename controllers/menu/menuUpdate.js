						...
						if (_.includes(allowedTypesForCratesLight, unit.type)) {
							...
							if(unit.coalition === 1) {
								cmdArray = _.concat(cmdArray, [
									...
									'missionCommands.addCommandForGroup("' + unit.groupId + '", "HQ-7_LN_SP(3Q-2C)", {' + aqMenuTitleHeavy + ', "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "MRSAM", ["type"] = "HQ-7_LN_SP", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true", ["mass"] = "564"})',
						...
						if (_.includes(allowedTypesForCratesHeavy, unit.type)) {
							...
							if(unit.coalition === 1) {
								cmdArray = _.concat(cmdArray, [
									...
									'missionCommands.addCommandForGroup("' + unit.groupId + '", "HQ-7_LN_SP(3Q-2C)", {' + aqMenuTitleHeavy + ', "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "MRSAM", ["type"] = "HQ-7_LN_SP", ["unitId"] = ' + unit.unitId + ', ["crates"] = 2, ["mobile"] = "true", ["mass"] = "1458"})',
