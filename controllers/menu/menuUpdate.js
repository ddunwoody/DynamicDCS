						...
						if (_.includes(allowedTypesForCratesLight, unit.type)) {
							...
							if(unit.coalition === 1) {
								cmdArray = _.concat(cmdArray, [
									...
									'missionCommands.addCommandForGroup("' + unit.groupId + '", "Leclerc(1Q-3C)", {' + aqMenuTitleLite + ', "Tanks"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "tank", ["type"] = "Leclerc", ["unitId"] = ' + unit.unitId + ', ["crates"] = 3, ["mobile"] = "true", ["mass"] = "533"})',
								...
								cmdArray = _.concat(cmdArray, [
									...
									'missionCommands.addCommandForGroup("' + unit.groupId + '", "M-1 Abrams(1Q-3C)", {' + aqMenuTitleLite + ', "Tanks"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "tank", ["type"] = "M-1 Abrams", ["unitId"] = ' + unit.unitId + ', ["crates"] = 3, ["mobile"] = "true", ["mass"] = "538"})',
