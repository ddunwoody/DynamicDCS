						...
						if (_.includes(allowedTypesForCratesLight, unit.type)) {
							...
							if(unit.coalition === 1) {
								cmdArray = _.concat(cmdArray, [
									...
									'missionCommands.addCommandForGroup("' + unit.groupId + '", "HQ-7(3Q-1C)", {' + aqMenuTitleLite + ', "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "MRSAM", ["type"] = "HQ-7", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true", ["mass"] = "564"})',
						...
						if (_.includes(allowedTypesForCratesHeavy, unit.type)) {
							...
							if(unit.coalition === 1) {
								cmdArray = _.concat(cmdArray, [
									...
									'missionCommands.addCommandForGroup("' + unit.groupId + '", "HQ-7(3Q-1C)", {' + aqMenuTitleHeavy + ', "Radar SAM"}, sendCmd, {["action"] = "f10Menu", ["cmd"] = "MRSAM", ["type"] = "HQ-7", ["unitId"] = ' + unit.unitId + ', ["crates"] = 1, ["mobile"] = "true", ["mass"] = "1458"})',
